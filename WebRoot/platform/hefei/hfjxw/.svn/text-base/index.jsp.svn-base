...
<div class="content">
  <div class="top">
   <div class="logo">
   		<s:if test="session.session_site.code=='anhui'"><img src="imgage/ahlogo.jpg" /></s:if>
   ...
   <div class="nav">
	 ...
	 <a href="pub_navProjectPublic.action?message=4" id="${message=='4'?'curTab':'' }">中小企业信息公开</a>
...
<s:if test="session.session_site.code=='anhui'">
 ...
 <div class="sheng">
  ...
  <td>
  	...
  	<c:if test="${not empty zhuanLanOrganList[status.index].footer }">
  		<a href="sitePub_${zhuanLanOrganList[status.index].code }.action">${zhuanLanOrganList[status.index].name }</a>
  	</c:if>
  </td>
  <td>
  	...
  	<c:if test="${not empty zhuanLanOrganList[status.index+1].footer }">
  		<a href="sitePub_${zhuanLanOrganList[status.index+1].code }.action">${zhuanLanOrganList[status.index+1].name }</a>
  	</c:if>
  </td>
  <td>
  	...
  	<c:if test="${not empty zhuanLanOrganList[status.index+2].footer }">
  		<a href="sitePub_${zhuanLanOrganList[status.index+2].code }.action">${zhuanLanOrganList[status.index+2].name }</a>
  	</c:if>
  </td>
  </tr>
  </c:forEach>
 ...
 <div class="sheng_top"></div>
  ...
  <td>
  	...
  	<c:if test="${not empty pingTaiOrganList[status.index].footer }">
  		<a href="sitePub_${pingTaiOrganList[status.index].code }.action">${pingTaiOrganList[status.index].name }</a>
  	</c:if>
  </td>
  <td>
  	...
  	<c:if test="${not empty pingTaiOrganList[status.index+1].footer }">
  		<a href="sitePub_${pingTaiOrganList[status.index+1].code }.action">${pingTaiOrganList[status.index+1].name }</a>
  	</c:if>
  </td>
  <td>
  	...
  	<c:if test="${not empty pingTaiOrganList[status.index+2].footer }">
  		<a href="sitePub_${pingTaiOrganList[status.index+2].code }.action">${pingTaiOrganList[status.index+2].name }</a>
  	</c:if>
  </td>
  </tr>
  </c:forEach>
 ...
 <div class="sheng_btm"></div>
  ...
  <div class="sheng_top"></div>
  <div class="sheng_text">
  <div class="sheng_title"><img src="imgage/other.jpg" /></div>
  <table border="0" cellpadding="0" cellspacing="0" class="sheng_table">
  <tr>
  <td><a href="#">北京市</a></td>
  <td><a href="#">天津市</a></td>
