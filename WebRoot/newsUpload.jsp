...
<body>
	...
	<form id="uploadFile" action="info/news_upload.action" enctype="multipart/form-data" method="post">
    	...
    	<table cellpadding="0" cellspacing="0"  class="table_add2">
		    ...
		    <s:iterator value="attachFileListNews" var="attach" status="statusaf">
		    <tr>
		      <td>${statusaf.index + 1}</td>
		      <td>${attach.realName }</td>
		      <td><a href="info/news_deleteFile.action?message=${attach.fileName }&id=${id }">删除</a></td>
		    </tr>
		    </s:iterator>
    	</table>
</body>
