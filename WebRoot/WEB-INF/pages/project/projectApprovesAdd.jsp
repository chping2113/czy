...
发布信息审批备案信息&nbsp;&gt;
    ...
    <div>
    <div class="main_text"><label>中小企业服务信息概要</label></div>
	...
	<input type="hidden" name="pageNo" value="${empty pageNo ? '1' : pageNo}" />	
     ...
     <tr>
      ...
      <tr>
      <th>可行性研究报告批复结果信息<br/>(资金报告批复结果信息)</th>
      <td  >
     ...
     <%   String str=request.getParameter("instr");
		    //System.out.println("list中"+str);
		    int flag=0;
		    if(str!=null)
		    {
		    ...
		    if(flag==1)
		    {
		       ...
		       <td>
		       <input type="checkbox" name="check" value="333" checked="true"> 
</td></tr>
