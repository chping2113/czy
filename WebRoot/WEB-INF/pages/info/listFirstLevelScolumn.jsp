...
<body>
 ...
 <div class="right_main">
 	<form action="info/scolumn_query.action" method="post">
    <div class="add_top">首页 > 平台管理 > 一级栏目编辑 </div>
    <div class="listop_search">一级栏目列表
    <a href="javascript:add()"><img src="images/add.jpg" border="0"/></a>
    <a href="system/site_list.action"><img src="images/back012.jpg" border="0"/></a>
    <span class="search">
    ...
    <tr>
     ...
     <tr>
       <td name="${scolumn.name }"><a href="javascript:view(${scolumn.id })">${util:limitText(scolumn.name,30) }</a></td>
       ...
       <td class="table_list_add">
         ...
         <a href="info/scolumn_view.action?id=${scolumn.id }&pageNo=${pageNo}&type=${type}">查看</a> -->
         <a href="javascript:edit(${scolumn.id })">编辑</a>
         <a href="info/scolumn_listSecond.action?parentId=${scolumn.id}&pageNo=${pageNo}&siteId=${siteId } ">下级栏目</a>
