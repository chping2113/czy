...
<%@ attribute name="paramName" required="true" rtexprvalue="true"%>
  ...
  <div id="dialog-query" title="搜索窗口" style="margin:0px; padding:0px; display:none; font:12px; "> 
       <div class="open-search">
             ...
             <input class="search-text" id="searchBox" type="text" value="" onkeyup="doFastSearch()"/>
	   </div>
  ...
  <script type="text/javascript">
    ...
    function doShowQueryWindow(searchUrl,fun,id,name,code,labelName) {
    	...
    	__commonQuery_query_onClickOK = fun+"('"+id+"','"+name+"','"+code+"')";
    	_name=name;
    	_id=id;
    	_code=code;
    	initOK();
    	...
    	var param = {};
		param[__commonQuery_paramName] = "";
    	$.post(searchUrl, param, function(ret) {
